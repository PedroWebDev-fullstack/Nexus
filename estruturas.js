...
{/*
  ...
  <div className="flex flex-col items-center justify-center w-screen h-screen gap-20 bg -[#090909]">
    <div className="flex items-center justify-center gap-4">
      <BotaoPrimario sm texto="Primário" /> 
      <BotaoPrimario md texto="Primário" /> 
      <BotaoPrimario lg texto="Primário" /> 
      <BotaoPrimario xl texto="Primário" /> 
    </div>
    
    <div className="flex items-center justify-center gap-4">
      <BotaoSecundario sm texto="Secundário" /> 
      <BotaoSecundario md texto="Secundário" /> 
      <BotaoSecundario lg texto="Secundário" /> 
      <BotaoSecundario xl texto="Secundário" /> 
    </div>

    <div className="flex items-center justify-center gap-4">
      <BotaoGhost sm texto="Ghost" /> 
      <BotaoGhost md texto="Ghost" /> 
      <BotaoGhost lg texto="Ghost" /> 
      <BotaoGhost xl texto="Ghost" /> 
    </div>

    <div className="flex items-center justify-center gap-4">
      <BotaoDanger sm texto="Danger" /> 
      <BotaoDanger md texto="Danger" /> 
      <BotaoDanger lg texto="Danger" /> 
      <BotaoDanger xl texto="Danger" /> 
    </div>

    <div className="flex items-center justify-center gap-4">
      <BotaoCta sm texto="Call to Atention" /> 
      <BotaoCta md texto="Call to Atention" /> 
      <BotaoCta lg texto="Call to Atention" /> 
      <BotaoCta xl texto="Call to Atention" /> 
    </div>
</div> */}
...
{/*
  ...
  status <-- define a cor da borda caso esteja "errado" ou "certo"
...
{/*
  ...
  <RemetenteMens texto="Eai mano tudo, c ta bem?"/>
  <DestinatarioMens  texto="Tudo sim e contigo?"/>
